...
class MixRatios {
  ...
  final double sandM3PerM3;
  final double gravelM3PerM3;
  final double waterLPerM3;
  final double steelKgPerM3;
  final String grade;
...
class CurrencyInfo {
  ...
  final double conversionFromSAR;
  const CurrencyInfo({
    required this.code,
...
const Map<String, CurrencyInfo> kCurrencies = {
  'SAR': CurrencyInfo(
      ...
      nameAr: 'ريال سعودي',
      nameEn: 'Saudi Riyal',
      conversionFromSAR: 1.0),
  'AED': CurrencyInfo(
      code: 'AED',
      symbol: 'د.إ',
      nameAr: 'درهم إماراتي',
      nameEn: 'UAE Dirham',
      conversionFromSAR: 1.02),
  'KWD': CurrencyInfo(
      code: 'KWD',
      symbol: 'د.ك',
      nameAr: 'دينار كويتي',
      nameEn: 'Kuwaiti Dinar',
      conversionFromSAR: 0.082),
  'USD': CurrencyInfo(
      code: 'USD',
      symbol: '\$',
      nameAr: 'دولار أمريكي',
      nameEn: 'US Dollar',
      conversionFromSAR: 0.267),
  'EGP': CurrencyInfo(
      code: 'EGP',
      symbol: 'ج.م',
      nameAr: 'جنيه مصري',
      nameEn: 'Egyptian Pound',
      conversionFromSAR: 8.5),
  'GBP': CurrencyInfo(
      code: 'GBP',
      symbol: '£',
      nameAr: 'جنيه إسترليني',
      nameEn: 'British Pound',
      conversionFromSAR: 0.21),
  'EUR': CurrencyInfo(
      code: 'EUR',
      symbol: '€',
      nameAr: 'يورو',
      nameEn: 'Euro',
      conversionFromSAR: 0.245),
  'TRY': CurrencyInfo(
      code: 'TRY',
      symbol: '₺',
      nameAr: 'ليرة تركية',
      nameEn: 'Turkish Lira',
      conversionFromSAR: 8.6),
};
...
class AppSettingsProvider extends ChangeNotifier {
  ...
  List<String> get gradesForCode => kCodeMixes[_code]!.keys.toList();
  ...
  void _loadFromBox() {
    ...
    _code =
        BuildingCode.values[_box.get('buildingCode', defaultValue: 0) as int];
    ...
    final grades = kCodeMixes[_code]!;
    _selectedGrade =
        _box.get('grade', defaultValue: grades.keys.first) as String;
